#Season.create(name:'Winter 2015', page_title:'Winter 2015 Movie Contest', slug:'2015w', bonus_amount: 5000000)
...
Movie.create(name:'The Peanuts Movie',
 plot:"Snoopy embarks upon his greatest mission as he and his team take to the skies to pursue their arch-nemesis,
 while his best pal Charlie Brown begins his own epic quest back home.",
 actors:"Noah Schnapp,
 Bill Melendez",
 release_date:'2015-11-06',
...
Movie.create(name:'By The Sea',
 plot:"A married couple takes a vacation in France in the 1970s and find that their time in a sleepy seaside town,
 complete with a unique array of locals,
 strengthens their bond and reaffirms their marriage.",
 actors:"Brad Pitt,
 Angelina Jolie",
 release_date:'2015-11-13',
...
Movie.create(name:'Creed',
 plot:"The former World Heavyweight Champion Rocky Balboa serves as a trainer and mentor to Adonis Creed,
...
Movie.create(name:'The Good Dinosaur',
 plot:"While traveling through a harsh and mysterious landscape,
 Arlo the Apatosaurus learns the power of confronting his fears and discovers what he is truly capable of.",
 actors:"Raymond Ochoa,
 Jeffrey Wright",
 release_date:'2015-11-25',
 director:'Peter Sohn',
...
Movie.create(name:'The Night Before',
 plot:"In New York City for their annual tradition of Christmas Eve debauchery,
 three lifelong best friends set out to find the Holy Grail of Christmas parties since their yearly reunion might be coming to an end.",
...
Movie.create(name:'Victor Frankenstein',
 plot:"Victor Frankenstein and his assistant Igor Strausman share a noble vision of aiding humanity through their groundbreaking research into immortality,
 but Victor's experiments go too far,
 and his obsession has horrifying consequences.",
 actors:"James McAvoy,
 Daniel Radcliffe",
 release_date:'2015-11-25',
...
Movie.create(name:'In the Heart of the Sea',
 plot:"Based on the 1820 event,
 a whaling ship is preyed upon by a sperm whale,
 stranding its crew at sea for 90 days,
...
Movie.create(name:'Concussion',
 plot:"The incredible true David vs. Goliath story of Dr. Bennet Omalu,
 the brilliant forensic neuropathologist who made the first discovery of CTE,
 a football-related brain trauma,
 in a pro player.",
 actors:"Will Smith,
 Alec Baldwin",
...
Movie.create(name:'Point Break',
 plot:"A young FBI agent infiltrates an extraordinary team of extreme sports athletes he suspects of masterminding a string of unprecedented,
...
Movie.create(name:'The Hateful Eight',
 plot:"In post-Civil War Wyoming,
 bounty hunters try to find shelter during a blizzard but get involved in a plot of betrayal and deception.",
